...
|소중한 SW 경진대회 참가|2024.03 ~|생성 AI를 활용한 서비스 개발||
</div>
...
|멋쟁이 사자처럼 12기 소개 홈페이지|2023.12~2024.02|프론트엔드, 백엔드, 디자이너가 협업하여 소개 페이지 및 게시판(공지사항, 질문, n주차 과제 제출 페이지) 등 LMS 제작|Django|
|혜음|2024.03 ~|프론트엔드, IOS 개발자와 협업하여 생성형 AI를 활용해 오늘 하루 감정 그림 일기 제작|Spring|
