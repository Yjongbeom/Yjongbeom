...
|유성구청 Living Lab Kick Off|지류 데이터가 너무 많고, 그걸 직원이 수기로 작성하여 많은 시간과 오타가 발생한다. 그래서 이걸 자동화하는 프로그램이다. OCR과 AI를 활용하여 기존 Excel파일이 있으면 기존 내용 아래에 데이터를 추가해주고, 없으면 테이블을 생성해준다. AI의 속도와 서버의 안정성을 높이기 위하여 Cache도 사용하였다.|
